...
export const Icons = {
    ...
    TrendingDown: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
    ...
    Wrench: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
    ...
    Cpu: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
    ...
    SpellCheck: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={cn("lucide lucide-spell-check-icon lucide-spell-check", props.className)}
            {...props}
        >
    ...
    SpellCheck2: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={cn("lucide lucide-spell-check2-icon lucide-spell-check-2", props.className)}
            {...props}
        >
            <path d="m6 16 6-12 6 12" />
            <path d="M8 12h8" />
    ...
    Plus: (props: SVGProps<SVGSVGElement>) => (
        <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={cn("lucide lucide-plus-icon lucide-plus", props.className)}
            {...props}
        >
            <path d="M5 12h14" />
            <path d="M12 5v14" />
    ...
    ImagePlus: (props: SVGProps<SVGSVGElement>) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={cn("lucide lucide-image-plus-icon lucide-image-plus", props.className)}
            {...props}
        >
            <path d="M16 5h6" />
            <path d="M19 2v6" />
